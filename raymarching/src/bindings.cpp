...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    // m.def("composite_rays_train_full_forward", &composite_rays_train_full_forward, "composite_rays_train_full_forward (CUDA)");
    // m.def("composite_rays_train_full_backward", &composite_rays_train_full_backward, "composite_rays_train_full_backward (CUDA)");
    // infer
