...
if __name__ == '__main__':
    ...
    # =================================================================================
    # training options
    parser.add_argument('--iters', type=int, default=32500,
                        help="training iters")
    ...
    parser.add_argument('--max_steps', type=int, default=4096,  # sk_debug: used to be 1024
    ...
    parser.add_argument('--dynamic_iters', type=str, default="{'d1': (0, 30000)}",  # 2400 iters
