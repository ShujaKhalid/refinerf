...
if __name__ == '__main__':
    ...
    # =================================================================================
    # training options
    parser.add_argument('--iters', type=int, default=36000,
                        help="training iters")
    ...
    parser.add_argument('--dynamic_iters', type=str, default="{'d1': (2400, 200000)}",  # 2400 iters
    ...
    parser.add_argument('--hidden_dim_deform', type=int,
                        default=0, help="time dim of encoder")
    parser.add_argument('--pred_intrinsics', type=int,
