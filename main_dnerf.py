...
if __name__ == '__main__':
    ...
    parser.add_argument('--dynamic_iters', type=str, default="{'d1': (0, 12000)}",  # 2400 iters
                        # parser.add_argument('--dynamic_iters', type=str, default="{'d1': (0, 12000)}",  # 24000 iters
                        help="intervals to train the dynamic model for")
    parser.add_argument('--update_extra_interval', type=int, default=1200000,  # TODO: used to be 100
