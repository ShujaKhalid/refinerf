...
if __name__ == '__main__':
    ...
    # parser.add_argument('--dynamic_iters', type=str, default="{'d1': (3600, 4200), 'd2': (4800, 6000), 'd3': (7200, 7800), 'd3': (8400, 9600)}",  # 2400 iters
    parser.add_argument('--dynamic_iters', type=str, default="{'d1': (0, 100000)}",  # 24000 iters
